...
export default function Sidebar() {
    ...
    return (
        <aside className="fixed md:static top-0 left-0 h-screen w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 z-40 overflow-y-auto">
